...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.Viewholder> {
    ...
    ChangeNumberItemListner changeNumberItemListener;

    public CartAdapter(ArrayList<PopularDomain> listItemSelected, Context context, ChangeNumberItemListner changeNumberItemListner) {
        this.listItemSelected = listItemSelected;
        managementCart=new ManagementCart(context);
        this.changeNumberItemListener=changeNumberItemListner;
    }
    ...
    public void onBindViewHolder(@NonNull CartAdapter.Viewholder holder, int position) {
        ...
        holder.plusItem.setOnClickListener(view -> managementCart.plusNumberItem(listItemSelected,position,new ChangeNumberItemListner(){
            public void change(){
        ...
        holder.minusItem.setOnClickListener(view -> {
            managementCart.minusNumberItem(listItemSelected, position, new ChangeNumberItemListner() {
                @Override
                public void change() {
                    notifyDataSetChanged();
                    changeNumberItemListener.change();
